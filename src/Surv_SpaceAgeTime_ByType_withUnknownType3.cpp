...
Type objective_function<Type>::operator() () {
  ...
  PARAMETER(logitrho_tmc_time3);  Type rho_tmc_time3  = geninvlogit(logitrho_tmc_time3, Type(-1.0), Type(1.0));
  ...
  nll += SEPARABLE(GMRF(Q_space), AR1(rho_tmc_time3))(u_spacetime_tmc);
  ...
  nll -= dnorm(logitrho_tmc_time3, Type(3), Type(2), TRUE); 
