...
/*******************************************************************/
template <class Type>
// Type threemc_type(Type x, Type a, Type b){
Type threemc_type(
    ...
    // Eigen::SparseMatrix<Type> A_mmc, Eigen::SparseMatrix<Type> A_tmc, 
    // Eigen::SparseMatrix<Type> A_mc, Eigen::SparseMatrix<Type> B, 
    // Eigen::SparseMatrix<Type> C, Eigen::SparseMatrix<Type> IntMat1, 
    // Eigen::SparseMatrix<Type> IntMat2, 
    // 
    // Eigen::SparseMatrix<Type> X_fixed_mmc, Eigen::SparseMatrix<Type> X_time_mmc,
    // Eigen::SparseMatrix<Type> X_age_mmc, Eigen::SparseMatrix<Type> X_space_mmc,
    // Eigen::SparseMatrix<Type> X_agetime_mmc, Eigen::SparseMatrix<Type> X_agespace_mmc,
    // Eigen::SparseMatrix<Type> X_spacetime_mmc, Eigen::SparseMatrix<Type> X_fixed_tmc,
    // Eigen::SparseMatrix<Type> X_age_tmc, Eigen::SparseMatrix<Type> X_space_tmc,
    // Eigen::SparseMatrix<Type> X_agespace_tmc,
    // 
    // Eigen::SparseMatrix<Type> Q_space,
    // 
    // vector<Type> u_fixed_mmc, vector<Type> u_fixed_tmc, vector<Type> u_age_mmc,
    // vector<Type> u_age_tmc, vector<Type> u_time_mmc, vector<Type> u_space_mmc, 
    // vector<Type> u_space_tmc, 
    // 
    // array<Type> u_agetime_mmc, array<Type> u_agespace_mmc, 
    // array<Type> u_spacetime_mmc, array<Type> u_agespace_tmc, 
    // 
    // // Type sigma_age_mmc, Type sigma_time_mmc, Type sigma_space_mmc,
    // // Type sigma_agetime_mmc, Type sigma_agespace_mmc, Type sigma_spacetime_mmc,
    // // Type sigma_age_tmc, Type sigma_space_tmc, Type sigma_agespace_tmc,
    // 
    // Type logsigma_age_mmc, Type logsigma_time_mmc, Type logsigma_space_mmc,
    // Type logsigma_agetime_mmc, Type logsigma_agespace_mmc, Type logsigma_spacetime_mmc,
    // Type logsigma_age_tmc, Type logsigma_space_tmc, Type logsigma_agespace_tmc,
    // 
    // // Type rho_mmc_time1, Type rho_mmc_time2, Type rho_mmc_time3,
    // // Type rho_mmc_age1, Type rho_mmc_age2, Type rho_mmc_age3, Type rho_tmc_age1,
    // // Type rho_tmc_age2 
    // 
    // Type logitrho_mmc_time1, Type logitrho_mmc_time2, Type logitrho_mmc_time3,
    // Type logitrho_mmc_age1, Type logitrho_mmc_age2, Type logitrho_mmc_age3, Type logitrho_tmc_age1,
