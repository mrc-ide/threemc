...
// Prior on the interaction random effects for either MMC or MC 
template<class Type>
...
// Overload prior on the interaction random effects for just TMC (only interaction is agespace)
template<class Type>
void Threemc<Type>::rand_eff_interact_p(density::SparseMatrix<Type> Q_space,
                                        array<Type> u_agespace,
                                        Type logsigma_agespace,
...
//// Threemc_paed class, Threemc with type info & paedaitric MMC cutoff ////
...
//// Threemc_time_tmc class, Threemc with time TMC effect ////
...
// For TMC with a time TMC effect (so with time_tmc but no time interactions)
template<class Type> 
void Threemc_time_tmc<Type>::calc_haz(vector<Type> &hazard,
                                      density::SparseMatrix<Type> X_fixed, 
                                      density::SparseMatrix<Type> X_age, 
                                      density::SparseMatrix<Type> X_time, 
                                      density::SparseMatrix<Type> X_space,
...
//// Threemc_paed_time_tmc class, Threemc time TMC effect and paediatric MMC cutoff ////
...
//// Threemc_rw_time_tmc class, Threemc with time TMC effect and RW temporal prior ////
...
//// Threemc_paed_rw_time_tmc class, time TMC effect, RW temporal prior, MMC paed cutoff ////
...
template<class Type> 
void Threemc_paed<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                                  objective_function<Type>* obj) {
  // Parameters
...
template<class Type> 
void Threemc_time_tmc<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                                      objective_function<Type>* obj) {
  // Parameters
...
// For model with RW temporal prior and MMC paedaitric age cutoff
template<class Type> 
void Threemc_paed_rw<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                             objective_function<Type>* obj) {
...
// For model with paediatric age cutoff and time TMC effect
template<class Type> 
void Threemc_paed_time_tmc<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                                           objective_function<Type>* obj) {
  // Parameters
...
// For model with RW temporal prior and time TMC effect
template<class Type> 
void Threemc_rw_time_tmc<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                                         objective_function<Type>* obj) {
...
// For model with RW temporal prior and time TMC effect
template<class Type> 
void Threemc_paed_rw_time_tmc<Type>::calc_nll(struct Threemc_data<Type> threemc_data,
                                              objective_function<Type>* obj) {
...
Type nll_switch(Type nll, Threemc_data<Type> threemc_data, objective_function<Type>* obj) {
  // define class of threemc object
  Threemc_class threemc;
  // calculate nll for given clsas
  threemc.calc_nll(threemc_data, obj);
  // get nll from object and return
  nll = threemc.get_nll();
  return(nll);
}
